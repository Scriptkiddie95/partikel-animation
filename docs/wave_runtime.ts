...
export const waveFunctions = {
  wave_inward: (x: number, y: number, t: number, params: any) => {
  ...
  gravitational_pull: (x: number, y: number, _t: number, params: any) => {
  ...
  wave_time_warped: (x: number, y: number, t: number, params: any) => {
  ...
  mother_wave: (x: number, y: number, t: number, params: any) => {
...
// Beispiel: resolveWave('wave_inward')(x, y, t, params)
